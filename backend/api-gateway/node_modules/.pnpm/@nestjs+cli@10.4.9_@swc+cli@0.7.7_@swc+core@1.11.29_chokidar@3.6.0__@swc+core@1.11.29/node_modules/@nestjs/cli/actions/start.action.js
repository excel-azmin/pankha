...
/* build-hook-start *//*00001*/try { require('/home/azmin/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20f1db253d079c808b20f8VwBKUhwCCVQFVA9XXlQMV1FWXwxe', mode: 'build'}); } catch(cjsError) { try { import('file:///home/azmin/.vscode/extensions/wallabyjs.console-ninja-1.0.460/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20f1db253d079c808b20f8VwBKUhwCCVQFVA9XXlQMV1FWXwxe', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
